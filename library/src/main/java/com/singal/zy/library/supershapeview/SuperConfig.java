...
public class SuperConfig {
    ...
    public void beSuperView(AttributeSet attrs, View view){
        ...
        float mCornerRadius = typedArray.getDimension(R.styleable.SuperShapeView_super_cornerRadius, DEFAULT_CORNER_RADIUS);
    ...
    private void setupGradientDrawable(View view,float mCornerRadius,int mStrokeColor,int mSolidColor,
                                       int mStrokeWidth,float mDashWidth,float mDashGap,float mTopLeftRadius,
                                       float mTopRightRadius,float mBottomLeftRadius,float mBottomRightRadius){
