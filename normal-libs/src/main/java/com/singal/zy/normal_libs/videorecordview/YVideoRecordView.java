package com.singal.zy.normal_libs.videorecordview;
...
public class YVideoRecordView extends SurfaceView implements MediaRecorder.OnErrorListener {
    ...
    public YVideoRecordView(Context context) {
        this(context, null);
    }

    public YVideoRecordView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public YVideoRecordView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.YVideoRecordView, defStyleAttr, 0);
        mXpx = typedArray.getInteger(R.styleable.YVideoRecordView_vrv_x_px, 320);// 默认320
        mYpx = typedArray.getInteger(R.styleable.YVideoRecordView_vrv_y_px, 240);// 默认240
        mOutFormat = typedArray.getInteger(R.styleable.YVideoRecordView_vrv_out_format, 1);//默认3gp
        mRecordMaxTime = typedArray.getInteger(R.styleable.YVideoRecordView_vrv_record_max_time, 10);//默认最长10秒
        mVideoEncodingBitRate = typedArray.getInteger(R.styleable.YVideoRecordView_vrv_video_encoding_bit_rate, 1 * 1024 * 1024);
        mVideoFrameRate = typedArray.getInteger(R.styleable.YVideoRecordView_vrv_video_frame_rate, 10);
        mIsOpenCamera = typedArray.getBoolean(R.styleable.YVideoRecordView_vrv_is_open_camera, true);
        typedArray.recycle();
