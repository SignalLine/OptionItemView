...
import com.singal.zy.normal_libs.ninegridimageview.YNineGridImageView;
import com.singal.zy.normal_libs.ninegridimageview.YNineGridImageViewAdapter;
import com.singal.zy.optionitemview.R;
import com.singal.zy.optionitemview.manager.ImageLoaderManager;
...
public class NineGridActivity extends AppCompatActivity {
    ...
    private YNineGridImageView mNgiv1, mNgiv2, mNgiv3, mNgiv4, mNgiv5, mNgiv6, mNgiv7, mNgiv8, mNgiv9;
    ...
    private void initView() {
        mNgiv1 = (YNineGridImageView) findViewById(R.id.ngiv1);
        mNgiv2 = (YNineGridImageView) findViewById(R.id.ngiv2);
        mNgiv3 = (YNineGridImageView) findViewById(R.id.ngiv3);
        mNgiv4 = (YNineGridImageView) findViewById(R.id.ngiv4);
        mNgiv5 = (YNineGridImageView) findViewById(R.id.ngiv5);
        mNgiv6 = (YNineGridImageView) findViewById(R.id.ngiv6);
        mNgiv7 = (YNineGridImageView) findViewById(R.id.ngiv7);
        mNgiv8 = (YNineGridImageView) findViewById(R.id.ngiv8);
        mNgiv9 = (YNineGridImageView) findViewById(R.id.ngiv9);
    }
    ...
    private void initData() {
        ...
        YNineGridImageViewAdapter adapter = new YNineGridImageViewAdapter<String>() {
            @Override
