...
import com.singal.zy.normal_libs.recycleview.YRecyclerView;
import com.singal.zy.optionitemview.R;
import com.singal.zy.optionitemview.model.DataBean;
...
public class RecycleActivity extends AppCompatActivity {
    ...
    private void initView() {
        mRv = (YRecyclerView) findViewById(R.id.rv);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.itemLinearV:
                mRv.setType(YRecyclerView.TYPE_GRID);
                mRv.setColumn(1);
                mRv.setOrientation(YRecyclerView.ORIENTATION_VERTICAL);
                mRv.notifyViewChanged();
                break;
            case R.id.itemLinearH:
                mRv.setType(YRecyclerView.TYPE_GRID);
                mRv.setColumn(1);
                mRv.setOrientation(YRecyclerView.ORIENTATION_HORIZONTAL);
                mRv.notifyViewChanged();
                break;
            case R.id.itemGridV:
                mRv.setType(YRecyclerView.TYPE_GRID);
            ...
            case R.id.itemStaggerV:
                mRv.setType(YRecyclerView.TYPE_STAGGER);
                mRv.setColumn(2);
                mRv.setOrientation(YRecyclerView.ORIENTATION_VERTICAL);
                mRv.notifyViewChanged();
                break;
