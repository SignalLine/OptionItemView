...
public abstract class YAdapterForAbsListView<T> extends BaseAdapter {
    //上下文
    ...
    public YAdapterForAbsListView(Context context, List<T> data,int defaultLayouId){
        mContext = context;
        mData = data;
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        //得到item对应的viewHolder
        YViewHolderForAbsListView viewHolder = getViewHolder(position,convertView,viewGroup);
     ...
     * @param position
     */
    public abstract void convert(YViewHolderForAbsListView viewHolder, T item, int position);
     ...
     */
    private YViewHolderForAbsListView getViewHolder(int position, View convertView, ViewGroup viewGroup) {
        YViewHolderForAbsListView holder = YViewHolderForAbsListView.get(mContext, mDefaultLayouId, position, convertView, viewGroup);
