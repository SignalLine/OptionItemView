...
import com.singal.zy.normal_libs.videorecordview.YVideoRecordView;
import com.singal.zy.optionitemview.R;
import com.singal.zy.optionitemview.manager.RecordProgress;

public class VideoRecordActivity extends AppCompatActivity implements YVideoRecordView.OnRecordStausChangeListener{

    private YVideoRecordView mVrvVideo;
    ...
    private void initView() {
        mVrvVideo = (YVideoRecordView) findViewById(R.id.vrvVideo);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN:
                        ...
                        //开始录制
                        mVrvVideo.record(VideoRecordActivity.this);
                        break;
    ...
    public void onRecrodFinish() {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                resetVideoRecord();
                //打开播放界面
                Intent intent = new Intent(VideoRecordActivity.this, SuccessActivity.class);
