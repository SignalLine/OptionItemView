...
public class UVideoPlayer extends FrameLayout implements UVideoPlayerControl, TextureView.SurfaceTextureListener {
    ...
    public UVideoPlayer(Context context) {
        this(context,null);
    }

    public UVideoPlayer(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init();
    }
    ...
    public void setController(UVideoPlayerController controller){
        ...
        mController.setUVideoPlayer(this);
    ...
    public void start() {
        ...
        UVideoPlayerManager.instance().setCurrentUVideoPlayer(this);
    ...
    private IMediaPlayer.OnCompletionListener mOnCompletionListener
        ...
        public void onCompletion(IMediaPlayer mp) {
            ...
            UVideoPlayerManager.instance().setCurrentUVideoPlayer(null);
        }
    };
