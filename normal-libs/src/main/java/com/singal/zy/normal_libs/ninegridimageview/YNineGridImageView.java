...
public class YNineGridImageView<T> extends ViewGroup {
    ...
    private YNineGridImageViewAdapter<T> mAdapter;

    public YNineGridImageView(Context context){
        super(context,null);
    }

    public YNineGridImageView(Context context, AttributeSet attrs){
        this(context, attrs,0);
    }

    public YNineGridImageView(Context context,AttributeSet attrs,int defStyleAttr){
        super(context, attrs, defStyleAttr);

        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.YNineGridImageView);
        this.mGap = (int) typedArray.getDimension(R.styleable.YNineGridImageView_imgGap, 8);
        typedArray.recycle();
    }
     ...
     * @param adapter 适配器
     */
    public void setAdapter(YNineGridImageViewAdapter adapter) {
        mAdapter = adapter;
    }
    ...
    private ImageView getImageView(final int position) {
        if (position < mImageViewList.size()) {
            ...
            if (mAdapter != null) {
                ...
                Log.e("YNineGridImageView", "你必须为YNineGridImageView设置YNineGridImageViewAdapter");
                return null;
            }
        }
    }
