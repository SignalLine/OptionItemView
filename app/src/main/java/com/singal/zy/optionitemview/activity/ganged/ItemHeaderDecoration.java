...
import com.singal.zy.optionitemview.activity.GangedRecycleActivity;
...
public class ItemHeaderDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDrawOver(Canvas c, final RecyclerView parent, RecyclerView.State state) {
        ...
        if (GangedRecycleActivity.left) {
            GangedRecycleActivity.left = false;
            return;
        }
        if (!Objects.equals(tag, currentTag)) {
            Log.d("tag---->", String.valueOf(GangedRecycleActivity.finalNumber));
            currentTag = tag;
