...
public abstract class YAdapterForRecyclerView<T> extends RecyclerView.Adapter<YViewHolderForRecyclerView>{
    private Context mContext;
    private int mDefaultLayoutId = 0;
    private List<T> mData;
    private YHeaderAndFooterAdapter mHeaderAndFooterAdapter;
     ...
     */
    public YAdapterForRecyclerView(Context context, List<T> data) {
        mContext = context;
        mData = data;
    }
     ...
     */
    public YAdapterForRecyclerView(Context context, List<T> data, int defaultLayoutId) {
        this(context, data);
    ...
    @Override
    public YViewHolderForRecyclerView onCreateViewHolder(ViewGroup parent, int viewType) {
        YViewHolderForRecyclerView holder = new YViewHolderForRecyclerView(mContext, View.inflate(mContext, viewType, null));
    ...
    @Override
    public void onBindViewHolder(YViewHolderForRecyclerView holder, int position) {
...
//    }
    ...
    public abstract void convert(YViewHolderForRecyclerView helper, T item, int position);
    ...
    public YHeaderAndFooterAdapter getHeaderAndFooterAdapter() {
        if (mHeaderAndFooterAdapter == null) {
            synchronized (YHeaderAndFooterAdapter.class) {
                if (mHeaderAndFooterAdapter == null) {
                    mHeaderAndFooterAdapter = new YHeaderAndFooterAdapter(this);
                }
            }
        }
