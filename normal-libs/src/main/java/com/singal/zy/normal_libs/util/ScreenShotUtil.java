...
/**
 *
 * Android截屏实现工具类 含ScrollView和ListView
 *
 * Created by li on 2017/5/3.
 */

public class ScreenShotUtil {
    private static String TAG = ScreenShotUtil.class.getSimpleName();
    /**
     * 获取指定activity的截屏，保存到png
     *
     * @param activity
     * @return
     */
    ...
    public static void shoot(Activity a) {
        ScreenShotUtil.savePic(ScreenShotUtil.takeScreenShot(a), "/sdcard/screen_test.png");
    }
    // 程序入口2
    public static void shootView(View view) {
        ScreenShotUtil.savePic(ScreenShotUtil.convertViewToBitmap(view),
                "sdcard/xx.png");
    }
