...
public class YHeaderAndFooterAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public YHeaderAndFooterAdapter(RecyclerView.Adapter innerAdapter){
