...
import com.singal.zy.library.util.DensityUtils;
...
public class TickView extends View{
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        mRingAnimatorDuration = mTickRateEnum.getRingAnimatorDuration();
        mCircleAnimatorDuration = mTickRateEnum.getCircleAnimatorDuration();
        mScaleAnimatorDuration = mTickRateEnum.getScaleAnimatorDuration();
        typedArray.recycle();
        applyConfig(mConfig);
        setUpEvent();
    }
    ...
    private void initPaint() {
        ...
        if(isChecked){
            ...
            mPaintRing.setColor(mConfig.getUnCheckBaseColor());
        }
        ...
        if(isChecked){
            ...
            mPaintTick.setColor(mConfig.getUnCheckBaseColor());
        }
    ...
    private void initAnimatorCounter() {
        ...
        //最后的放大再回弹的动画，改变画笔的宽度实现
        ObjectAnimator mScaleAnimator = ObjectAnimator.ofFloat(this,"ringStrokeWidth",
                mPaintRing.getStrokeWidth(), mPaintRing.getStrokeWidth() * SCALE_TIMES,
                mPaintRing.getStrokeWidth() / SCALE_TIMES);
            ...
            public void onClick(View v) {
                if(mConfig.isClickable()){
                    ...
                    if(mConfig.getOnCheckedChangeListener() != null){
                        mConfig.getOnCheckedChangeListener().onCheckedChanged((TickView)v,isChecked);
                    }
                }
            }
        });
